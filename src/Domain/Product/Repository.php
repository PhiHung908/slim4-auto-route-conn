...
use App\Domain\Product\RepositoryInterface;
...
class Repository implements RepositoryInterface
{
    ...
    public function __construct($em, $db = null, $appSettings = null)
    {
		...
		$this->_em_Repository = $this->_em->getRepository(Product::class);
		$this->_db = $db;
    ...
    {
		return array_values($this->_em_Repository->findAll(Product::class));
    }
